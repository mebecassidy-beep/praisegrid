...
export default function TermsPage() {
  return (
    <LegalPageLayout title="Terms of Service" updated="July 2026">
      <LegalP>
        These Terms of Service (&quot;Terms&quot;) govern your access to and use of Praisegrid. By
        creating an account, you agree to these Terms.
      </LegalP>

      <LegalH2>Using Praisegrid</LegalH2>
      <LegalP>
        You must provide accurate account information and are responsible for activity
        that happens under your account. You agree to use Praisegrid only for lawful
      ...
      <LegalP>
        Praisegrid uses AI to draft review responses based on your business&apos;s tone and
      ...
      <LegalP>
        You may stop using Praisegrid and close your account at any time. We may suspend
